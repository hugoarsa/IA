(define (problem book-plan-10)
  (:domain book-plan)
  (:objects
    Book0 Book1 Book2 Book3 Book4 Book5 Book6 Book7 Book8 Book9 - Book ; List all the books
  ...
  (:init
    ...
    (parallel Book8 Book5)
    (parallel Book6 Book9)
    (parallel Book9 Book6)
    (parallel Book7 Book9)
    (parallel Book9 Book7)
    (goal Book1)
    (goal Book7)
    (read Book9)
